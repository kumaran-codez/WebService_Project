...
public class ObjectFactory {
    ...
    private final static QName _DivideRResponse_QNAME = new QName("http://WebService/", "divideRResponse");
    private final static QName _Subtract_QNAME = new QName("http://WebService/", "subtract");
    private final static QName _DivideLResponse_QNAME = new QName("http://WebService/", "divideLResponse");
    private final static QName _DivideR_QNAME = new QName("http://WebService/", "divideR");
    private final static QName _MultiplyResponse_QNAME = new QName("http://WebService/", "multiplyResponse");
    private final static QName _Multiply_QNAME = new QName("http://WebService/", "multiply");
    private final static QName _DivideL_QNAME = new QName("http://WebService/", "divideL");
    private final static QName _SubtractResponse_QNAME = new QName("http://WebService/", "subtractResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebService/", name = "divideRResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebService/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebService/", name = "divideLResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebService/", name = "divideR")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebService/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebService/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebService/", name = "divideL")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WebService/", name = "subtractResponse")
